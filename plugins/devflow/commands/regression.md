...
/devflow:regression add TRD-001

# Run all regression tests
/devflow:regression run

# Run only unit tests
/devflow:regression run unit

# Capture new UI baselines
/devflow:regression run ui --baseline

# View history
/devflow:regression report
```

## How It Works

1. Complete a TRD: `/devflow:trd status 001 complete`
2. Add its tests: `/devflow:regression add TRD-001`
