...
description: |
  Archive the current milestone, tag a git release, and prepare the workspace for the next version.
  Irreversible — archives the roadmap, requirements, and creates a git tag.
