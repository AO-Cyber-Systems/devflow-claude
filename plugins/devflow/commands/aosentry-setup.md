...
name: aosentry-setup
description: |
  Connect Claude Code to an AOSentry instance for AI media generation, vision analysis, speech, and gateway management.
  Use when the user wants to configure AOSentry MCP servers in their project.
