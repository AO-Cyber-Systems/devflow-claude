...
/devflow:onboard analyze

# Full onboarding pipeline
/devflow:onboard full

# Onboard with TRD generation for existing features
/devflow:onboard full --create-trds

# Import requirements from a document
/devflow:onboard import --source README.md

# Import GitHub issues as TRDs
/devflow:onboard import --github-issues

# Analyze a different project
/devflow:onboard analyze --target /path/to/project

# Dry run to see what would happen
/devflow:onboard full --dry-run
```
...
├── feature_list.json   # (after /devflow:features sync)
...
2. Run `/devflow:verify run` to test checks
3. Run `/devflow:features sync` to generate feature list
4. Create new TRDs: `/devflow:trd create "Feature name"`
5. Start autonomous dev: `/devflow:autonomous`
