...
/devflow-agent:uitest list

# Extract scenarios from TRD
/devflow-agent:uitest extract TRD-001

# Get instructions for running a scenario
/devflow-agent:uitest run "Login flow"

# Get baseline capture instructions
/devflow-agent:uitest baseline TRD-001
```
...
2. Run `/devflow-agent:uitest run <scenario>` to get instructions
