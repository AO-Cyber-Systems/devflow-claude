...
**CRITICAL:** If CONTEXT.md exists from /devflow:discuss-objective, copy locked decisions here verbatim. These MUST be honored by the jobner.
...
**Structure:**
- Use XML tags for section markers (matches DevFlow templates)
