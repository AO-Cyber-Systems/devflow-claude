...
[What were you thinking about? What was the job?
...
- `objective`: Directory name (e.g., `02-authentication`)
- `task`: Current task number
- `total_tasks`: How many tasks in objective
