...
For deep ecosystem research ("how do experts build this"), use `/df:research-objective` which produces RESEARCH.md.
...
<discovery_objective>
Discover [topic] to inform [objective name] implementation.
...
- [Defer to implementation objective]
</exclude>
</discovery_scope>
...
- Use `/df:research-objective` for these
</guidelines>
