...
- [E001] config.json: JSON parse error at line 5
  Fix: Run /df:health --repair to reset to defaults

- [E002] PROJECT.md not found
  Fix: Run /df:new-project to create
```
...
```
---
N issues can be auto-repaired. Run: /df:health --repair
```
</step>
...
```
Would you like to run /df:health --repair to fix N issues automatically?
```
