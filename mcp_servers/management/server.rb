...
server = MCP::Server.new(
  name: "aosentry-management",
  version: "1.0.0",
  tools: [
    # Spend analytics
    GetSpendSummary, GetSpendByKeys, GetSpendByModels, GetSpendByProvider, GetSpendLogs,
    # Key management
    ListKeys, GenerateKey, GetKeyInfo, RotateKey, BlockKey, UnblockKey, DeleteKey,
    # Guardrails
    ListGuardrails, GetGuardrail, CreateGuardrail, UpdateGuardrail, DeleteGuardrail,
    GetGuardrailLogs, GetGuardrailStats,
    # Models
    ...
    # Budgets
    ListBudgets, CreateBudget, UpdateBudget, DeleteBudget, GetBudgetInfo,
    # Config
