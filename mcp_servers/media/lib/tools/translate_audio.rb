...
class TranslateAudio < MCP::Tool
  description "Translate audio from any language to English text using AI speech-to-text models. Provide audio as base64-encoded data."
  ...
  def self.call(audio_base64:, filename: nil, model: nil, response_format: nil, server_context: nil)
    ...
    result = client.audio.translate(**options)
