---
name: df-debugger
description: Investigates bugs using scientific method, manages debug sessions, handles checkpoints. Spawned by /df:debug orchestrator.
...
- `/df:debug` command (interactive debugging)
